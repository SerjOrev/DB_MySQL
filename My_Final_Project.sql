...
-- триггер при вставке новых записей в таблицу change_np, вставляет значение в поле prefix как первые 2 цыфры от номера телефона.
...
from cdr c
	    ...
	    join profiles p  on p.cust_id = n.cust_id 
	     ...
	     and c.call_release < STR_TO_DATE('2021-05-01', '%Y-%m-%d');
...
select * from outgoing_per_client_in_march;
